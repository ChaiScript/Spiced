...
if (NOT ${SFML_INCLUDE_DIR} STREQUAL "")
  get_filename_component(INCLUDE_PARENT_DIR ${SFML_INCLUDE_DIR} PATH)
  list(APPEND FIND_SFML_PATHS ${INCLUDE_PARENT_DIR})
endif()
...
if(SFML_FIND_VERSION AND SFML_INCLUDE_DIR)
    ...
    if (NOT SFML_VERSION_PATCH GREATER -1)
